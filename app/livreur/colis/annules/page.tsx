...
import { Package, Search, Filter, X, Loader2 } from "lucide-react"
...
export default function LivreurColisAnnulesPage() {
  // State for data
  ...
  <div className="grid grid-cols-1 md:flex md:flex-wrap gap-4 items-end">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow-sm border p-6">
          ...
          <h3 className="text-lg font-medium mb-2">Aucun colis annulé</h3>
          <p className="text-muted-foreground">
            Vous n'avez actuellement aucun colis annulé.
          </p>
        </div>
      ) : (
