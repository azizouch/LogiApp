...
import { PackageX, Search, Filter, X, Loader2, Package } from "lucide-react"
...
export default function LivreurColisRefusesPage() {
  // State for data
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Vos colis qui ont été refusés par les clients
            </p>
          </div>
  ...
  <div className="grid grid-cols-1 md:flex md:flex-wrap gap-4 items-end">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow-sm border p-6">
          <PackageX className="mx-auto h-12 w-12 text-muted-foreground opacity-50 mb-4" />
          <h3 className="text-lg font-medium mb-2">Aucun colis refusé</h3>
          <p className="text-muted-foreground">
            Vous n'avez actuellement aucun colis refusé.
          </p>
        </div>
      ) : (
